                                        ...
                                        <div className="card-body">
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-sm-9 text-secondary">
                                                    <input placeholder={doctor_name}  className="form-control" disabled/>
                                                </div>
                                            </div>
                                            <div className="row mb-3">
                                                <div className="col-sm-3">
                                            ...
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-sm-9 text-secondary">
                                                    <input type="text" className="form-control" placeholder={degree} disabled/>
                                                </div>
                                            </div>
                                            <div className="row mb-3">
                                                <div className="col-sm-3">
                                                ...
                                                <div className="col-sm-9 text-secondary">
                                                    <input type="text" className="form-control" placeholder={experience} disabled/>
                                                </div>
                                            </div>
                                            <div className="row mb-3">
                                                <div className="col-sm-3">
                                                ...
                                                <div className="col-sm-9 text-secondary">
                                                    <input type="text" className="form-control" placeholder={hospital_name} disabled/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="row mb-3">
                                ...
                                <div className="col-sm-9 text-secondary">
                                    <input type="text" className="form-control" placeholder={password} disabled/>
                                </div>
                            </div>
                            <div className="row mb-3">
                                <div className="col-sm-3">
